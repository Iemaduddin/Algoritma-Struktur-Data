package Pertemuan_15.Tugas.Nomor_3;
...
public class Tugas3_Graph {
    int vertex;
    LinkedLists list[];

    public Tugas3_Graph(int vertex){
        this.vertex = vertex;
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            do {
                ...
                Tugas3_Graph graph = new Tugas3_Graph(vertex);
